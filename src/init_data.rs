...
pub const ALIVE_FUNGI_COLOR_1: (f32,f32,f32) = (1.0, 0.0, 0.0);
pub const ALIVE_FUNGI_COLOR_2: (f32,f32,f32) = (0.5, 0.0, 0.0);
pub const ALIVE_FUNGI_COLOR_3: (f32,f32,f32) = (0.2, 0.0, 0.0);
